...
public class CompareSystemAnswers {
	public static void main(String[] args) throws Exception {
			URL answerFileURL = CompareSystemAnswers.class.getResource("/org/aksw/queryexpansion/benchmark/systems/answers/qald-4_multilingual_test_questions_diffWords_BM25F_answer.xml");
